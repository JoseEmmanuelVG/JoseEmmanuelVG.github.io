...
Functional, usability, and reliability tests validated:  
- Stable WiFi communication between modules.  
- Real-time web-based control and monitoring.  
- Accurate execution of motion and cleaning tasks.  
- Responsive interface under different network conditions.  

Demonstration videos:
- `UI_Navigation_JEVG.mp4` — navigation interface tests.  
- `UI_Validation_JEVG.mp4` — control module validation.  
- `RobotWorking_JEVG.mp4` — final prototype performance.  
